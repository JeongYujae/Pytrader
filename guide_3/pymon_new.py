...
#급등주 포착 알고리즘
    ...
    def update_buy_list(self, buy_list):
        ...
        f.close()
#증권시장의 전 종목에 대해 국채시가배당률 기반으로 매수 여부 체크
    def run(self):
        buy_list = []
...
#현금배당수익률, 3년만기 국채익률의 일별 시세를 조회하여 국채시가배당률을 계산하자!
    ...
    def calculate_estimated_dividend_to_treasury(self, code):
        ...
        estimated_dividend_to_treasury = float(estimated_dividend_yield) / float(current_3year_treasury) #국채시가 배당률=현금배당수익률/3년만기 국채수익률
        return estimated_dividend_to_treasury

#5년치에 대한 국채시가 배당률 중 max, min 값 반환
...
#국채시가배당률 > 과거 5년치 국채시가배당률의 max값 -> 매수!
    ...
    def run_dividend(self):
        ...
        for code in self.kospi_codes[400:900]:
            time.sleep(0.5)
...
if __name__ == "__main__":
    ...
    print(pymon.buy_check_by_dividend_algorithm("005380"))
